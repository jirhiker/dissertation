...
\includepdf[pages={-}, landscape=true, addtolist={1, table, Table 1., foo1}]{../src/data/minna_bluff/tables/table.pdf}
...
\includepdf[pages={-}, landscape=true, addtolist={1, table, Table 2., foo1}]{../src/data/minna_bluff/tables/table.pdf}

\includepdf[pages={-}, landscape=true, addtolist={1, table, Table 3, foo1}]{../src/data/minna_bluff/tables/table.pdf}




\keywords{Antarctica; Ar-Ar geochronology; Python}
\end{abstract}
%----------------------------------------------------------------
...
\bibliography{../src/data/andrill/andrill, ../src/data/minna_bluff/minna_bluff, ../src/data/diode/pychron, ../src/data/pychron/pychron}
\end{References}
\copyrightpage
\end{document}
